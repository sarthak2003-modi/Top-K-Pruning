# %% =============================== #
#  DenseNet-121 on CIFAR-100 @ 224x224 - OPTIMIZED VERSION
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='DenseNet-121 sparse training on CIFAR-100 (optimized)'
    )
...
# ----------------- Model loading -----------------
def load_densenet121_cifar100(pretrained=True):
...
if __name__ == '__main__':
    ...
    # Optimized transforms (removed some augmentations for speed if needed)
    ...
    # Model
    print("Loading model...")
    model = load_densenet121_cifar100(pretrained=True).to(device)
